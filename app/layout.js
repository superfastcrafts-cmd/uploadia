      ...
      <body className="min-h-screen">
        <header className="sticky top-0 z-10 backdrop-blur bg-black/40 border-b border-white/10">
          <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
            <Link href="/" className="font-extrabold tracking-tight text-xl">Uploadia</Link>
        ...
        <footer className="max-w-5xl mx-auto px-4 py-10 text-center text-sm text-slate-400">
